...
class GradleProcess:
    def __init__(self, build_dir: str, version: str):
        ...
        self._TO_COPY: list[str] = ["gradle", "mappings", "unpick-definitions", "build.gradle", "gradle.properties", "gradlew", "gradlew.bat", "nests-builds.json", "signatures-builds.json", "exceptions-builds.json", "settings.gradle"]
